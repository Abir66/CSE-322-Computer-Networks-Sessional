...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("coverageArea", "Coverage area of each AP node", coverageArea);
    ...
    channelLeft.AddPropagationLoss("ns3::RangePropagationLossModel", "MaxRange", DoubleValue(coverageArea * Tx_Range));
    channelRight.AddPropagationLoss("ns3::RangePropagationLossModel", "MaxRange", DoubleValue(coverageArea * Tx_Range));
    ...
    output_delivery_ratio.open("scratch/output/1905066_1_delivery_ratio.dat", std::ios::app);
    output_throughput.open("scratch/output/1905066_1_throughput.dat", std::ios::app);
    output_delivery_ratio<<nNodes<<" "<<nFlows<<" "<<nPacketsPerSecond<<" "<<coverageArea<<" "<<packet_delivery_ratio<<std::endl;
    output_throughput<<nNodes<<" "<<nFlows<<" "<<nPacketsPerSecond<<" "<<coverageArea<<" "<<throughput<<std::endl;
